...
\begin{center}
\begin{tabular}{c|ccc}
subselang, $i$ & Aturan Simpson komposit & galat absolut, $e_{i}$ & rasio galat, $\frac{e_{i}}{e_{i+1}}$\tabularnewline
\hline 
...
menghampiri $\int_{5}^{12}f(x)\,dx$, dan galat absolutnya ternyata
...
hampiran yang disarankan dalam soal \ref{est1}. Apakah galat absolutnya
kurang dari $10^{-4}$? \hasananswer 
\item \octave\ Gunakan Octave untuk menghitung taksiran yang disarankan
dalam soal \ref{est2}. Apakah galat absolutnya kurang dari $10^{-4}$?
