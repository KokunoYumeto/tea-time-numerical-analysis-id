...
bagi $\hat{x}$ dengan galat mutlak tidak lebih dari $M^{k}|x_{0}-\hat{x}|$.
\end{prop}
...
batas galat tersebut. Galat mutlak ketika menghampiri $\hat{x}$ dengan
$x_{0}$ adalah $|x_{0}-\hat{x}|=M^{0}|x_{0}-\hat{x}|$ sehingga pernyataan
tersebut benar untuk $k=0$. Sekarang misalkan pernyataan itu benar
untuk suatu nilai tertentu tetapi sembarang $k\geq0$. Berdasarkan
...
\begin{centering}
$f_{1}$: \includegraphics{figures/roots-order1}
\par\end{centering}
\begin{centering}
$f_{2}$: \includegraphics{figures/roots-order2}
\par\end{centering}
\begin{centering}
$f_{3}$: \includegraphics{figures/roots-order3}
\par\end{centering}
\begin{centering}
$f_{4}$: \includegraphics{figures/roots-order4}
\par\end{centering}
\begin{centering}
$f_{5}$: \includegraphics{figures/roots-order5}
\par\end{centering}
...
terhadap $\hat{x}$ dengan galat mutlak tidak lebih dari $M^{k}|x_{0}-\hat{x}|$.
