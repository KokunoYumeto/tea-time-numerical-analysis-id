...
metode Müller (selama hampiran tetap riil), atau metode Sidi (Bagian
...
\centering{}\includegraphics{figures/rootBracketing01}
\end{figure}
...
Seperti yang mungkin Anda ingat, metode Müller memerlukan tiga hampiran
...
Dengan demikian, metode Müller juga dapat disebut ``metode interpolasi
kuadratik''.
...
Dengan merujuk kembali pada penurunan metode Müller \vpageref{subsec:mullers},
...
Müller. Memang, setiap metode interpolasi kuadratik konvergen menuju
...
\centering{}\includegraphics{figures/rootBracketing02}\qquad{}\includegraphics{figures/rootBracketing03}
\end{figure}
...
daripada galat mutlak pada setiap langkah. Situasi ini tidak lazim,
...
toleransi tertentu bergantung pada galat mutlak. Ketika akar mungkin
