...
Ada dua ukuran dasar akurasi\index{akurasi}: galat mutlak\index{galat!mutlak}
...
Karena itu, kita paling sering membicarakan galat mutlak\index{galat!mutlak},
$|\tilde{p}-p|$. Anda mungkin mengenali ekspresi $|\tilde{p}-p|$
sebagai jarak antara $\tilde{p}$ dan $p$, dan itu merupakan cara
yang baik untuk memandang galat mutlak.

Galat mutlak ketika menghampiri $p=\pi$ dengan bilangan rasional
$\tilde{p}=\frac{22}{7}$ adalah $|\frac{22}{7}-\pi|\approx0.00126$.
Galat mutlak ketika menghampiri $\pi^{5}$ dengan bilangan rasional
$\frac{16525}{54}$ adalah $|\frac{16525}{54}-\pi^{5}|\approx0.00116$.
Galat mutlak kedua hampiran ini hampir sama. Agar hal tersebut tampak
...
inti galat relatif: membandingkan galat mutlak dengan besar nilai
...
kira-kira dua angka signifikan dalam akurasi), meskipun galat mutlaknya
...
\]
yang sekecil mungkin seperti yang dapat diharapkan. Galat mutlak $|\tilde{p}(10^{-2})-f'(1)|=|0.5402933008747335-\cos(1)|$
pada dasarnya sepenuhnya bersifat algoritmik. Galat pembulatan jauh
lebih kecil daripada galat algoritmik. Fakta bahwa kita menggunakan
aritmetika titik-mengambang dapat diabaikan. 
...
\item [{Galat~mutlak\index{galat!mutlak}:}] $|\tilde{p}-p|$ disebut
galat mutlak ketika menggunakan $\tilde{p}$ untuk menghampiri nilai
$p$.
...
\item [{Galat~pemotongan\index{galat!pemotongan}:}] Galat algoritmik
...
nilai mutlak, sinus, dan kosinus. Untungnya, semua ini cukup mudah
...
Fungsi standar seperti nilai mutlak, sinus, dan kosinus (serta banyak
...
dengan demikian akan jelas cara mencari sinus atau nilai mutlak suatu
...
\item Hitung galat mutlak dan galat relatif ketika menghampiri $\pi$ dengan
3.
\item \label{ex:absoluteError}Hitung galat mutlak ketika menghampiri $p$
dengan $\tilde{p}$.
...
\item Hitung galat mutlak dan galat relatif ketika menghampiri $p$ dengan
$\tilde{p}$.
...
terhadap $1/\pi$. Dengan Octave, tentukan galat mutlak dan galat
...
\item \label{exc:abserr8}$\tilde{p}$ menghampiri $p$ dengan galat mutlak
$\frac{1}{100}$ dan galat relatif $\frac{3}{100}$. Tentukan $p$
dan $\tilde{p}$. \hasananswer 
\item $\tilde{p}$ menghampiri $p$ dengan galat mutlak $\frac{3}{100}$
...
Hitung galat mutlak dan galat relatif pada hampiran-hampiran berikut
terhadap $e$:
...
sehingga galat relatif sama dengan galat mutlak. Nyatakan secara umum
kondisi yang menyebabkan hal ini terjadi. \hasananswer 
\item Tentukan nilai $p$ dan $\tilde{p}$ sedemikian sehingga galat relatif
lebih besar daripada galat mutlak. Nyatakan secara umum kondisi yang
menyebabkan hal ini terjadi.
\item Tentukan nilai $p$ dan $\tilde{p}$ sedemikian sehingga galat relatif
lebih kecil daripada galat mutlak. Nyatakan secara umum kondisi yang
menyebabkan hal ini terjadi.
\item Hitung (i) $\tilde{p}$ dengan kalkulator atau komputer (perhitungan
titik-mengambang), (ii) galat mutlak, $|\tilde{p}-p|$, dan (iii)
