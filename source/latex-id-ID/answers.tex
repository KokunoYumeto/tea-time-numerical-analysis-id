...
$1$, tidak ada perbedaan antara pengujian galat mutlak dan galat
relatif. (e) Karena akar bernilai sekitar lima ratus, metode berhenti
ketika galat mutlak baru sekitar $10^{-6}\cdot500=5(10)^{-4}$. Akibatnya,
metode berhenti satu iterasi lebih awal ketika memeriksa galat relatif
dibandingkan ketika memeriksa galat mutlak.
\end{description}
...
(d) $\frac{\pi^{3}}{36}\approx0.8612854633416616$ (e) galat mutlak
...
mengetahui seberapa baik hampiran tersebut, galat mutlak pada $t=11$
...
pemotongan lokal rumus integrasi yang mendasarinya; ya, satu derajat
...
lebih rendah daripada galat pemotongan lokal rumus integrasi yang
