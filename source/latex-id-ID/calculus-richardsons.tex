...
absolut dari $T_{5}(0,1)$, $T_{10}(0,1),$ dan $T_{15}(0,1)$ adalah
\begin{eqnarray*}
...
Gunakan informasi ini untuk menghitung $T_{5,3}$ beserta galat absolutnya.
...
\item [{$T_{5,3}$~dan~galat~absolutnya:}] \label{t35}$\frac{\left|\int_{0}^{1}\sin x\,dx-T_{5,2}\right|}{\left|\int_{0}^{1}\sin x\,dx-T_{10,2}\right|}\approx\frac{1.522(10)^{-11}}{2.374(10)^{-13}}\approx64$
sehingga 
\begin{eqnarray*}
