...
mutlak untuk setiap hampiran. Galat pada PDB-trapesium kira-kira 0.01
hingga 0.1, sedangkan galat pada metode Euler kira-kira 0.2 hingga
...
\begin{table}
\caption{\label{tab:odeCompare}Perbandingan galat mutlak untuk lima penyelesai
PDB}
