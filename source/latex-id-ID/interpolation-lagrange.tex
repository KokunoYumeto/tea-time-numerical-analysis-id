...
\hline 
\includegraphics[scale=0.75]{figures/interpolation-polynomials1} & \includegraphics[scale=0.75]{figures/interpolation-polynomials2}\tabularnewline
\includegraphics[scale=0.75]{figures/interpolation-polynomials3} & \includegraphics[scale=0.75]{figures/interpolation-polynomials4}\tabularnewline
\includegraphics[scale=0.75]{figures/interpolation-polynomials5} & \includegraphics[scale=0.75]{figures/undefined}\tabularnewline
\end{tabular}
\end{figure}
...
metode ini menggunakan parabola yang sama dengan metode Müller, tetapi
dengan cara yang berbeda. Pada metode Müller, iterasi berikutnya diperoleh
